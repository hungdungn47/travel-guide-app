...
class AppTheme {
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    textTheme: TextTheme(
      ...
      titleLarge: const TextStyle().copyWith(fontSize: 24, fontWeight: FontWeight.w400, color: Colors.black),
      titleMedium: const TextStyle().copyWith(fontSize: 22, fontWeight: FontWeight.w400, color: Colors.black),
      titleSmall: const TextStyle().copyWith(fontSize: 20, fontWeight: FontWeight.w400, color: Colors.black),

      bodyLarge: const TextStyle().copyWith(fontSize: 18, fontWeight: FontWeight.w400, color: Colors.black),
      bodyMedium: const TextStyle().copyWith(fontSize: 16, fontWeight: FontWeight.w400, color: Colors.black),
